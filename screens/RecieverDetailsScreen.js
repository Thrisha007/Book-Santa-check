    ...
    render(){
        return(
            <View style = {styles.container}>
                ...
                <View style = {{flex:0.1}}>
                    <Header 
                        leftComponent = {<Icon name = 'arrow-left' type = 'feather' color = 'pink' onPress = {()=>{
                            this.props.navigation.goBack()}}/>}
                        centerComponent = {{text: "Donate books",style:{color: 'green',fontSize:RFValue(20),fontWeight:'bold'}}} 
